...
function Home() {
  return (
    <div id="Home" className="p-20 py-27 md:flex items-center md:justify-between w-full ">
      <div>
        ...
        <div className="mt-6 text-xl flex justify-center md:flex md:justify-normal md:text-3xl text-white">
          Frontend Developer
        </div>

        <div className="text-gray-400 mt-5 text-sm ml-3 md:text-lg max-w-xl leading-6">
          <span>
